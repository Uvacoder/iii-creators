...
It has been a while since I created a full stack website and so remembering how to use async/await functions and implementing CRUD operations were a bit of a challenge, but a good one. Styling the site also took a while but it was fun to implement good UI/UX design principles and make the site easy to navigate.
